...
<head>
    ...
    <title>{{ __('messages.errors.422_title') }} | {{ \App\Support\PlatformBrand::name() }}</title>
...
<body class="app-shell error-page">
    <main class="error-page-shell">
        <div class="error-card">
            ...
            <p class="eyebrow">{{ __('messages.errors.code', ['code' => 422]) }}</p>
            <h1>{{ __('messages.errors.422_title') }}</h1>
            <p>{{ __('messages.errors.422_message') }}</p>
