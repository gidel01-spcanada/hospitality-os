...
7. Implement dual-currency pricing and availability with concurrency protection.
8. Implement iCalendar imports, exports, cron, and failure handling.
9. Implement pending-payment reservations and the Mobile Money/PayPal gateway adapters with sandbox tests, webhooks, reconciliation, and refund/manual-review paths.
10. Implement guest/account flows and the transactional email outbox.
11. Recreate and finish the customer-facing UI from the samples using all supplied property images.
12. Add tests, security hardening, accessibility, and performance work.
13. Build and validate the Bluehost release/deployment workflow.
14. Run the full test/build suite and complete the acceptance checklist.
