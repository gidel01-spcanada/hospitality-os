...
class RevolutGateway implements PaymentGateway
{
    ...
    public function createIntent(Reservation $reservation, array $context = []): PaymentAttempt
    {
        return PaymentAttempt::query()->create([
            ...
            'provider' => $this->name(),
            'provider_reference' => 'revolut-' . Str::upper(Str::random(12)),
            'currency' => $context['currency'] ?? $reservation->currency,
            'amount' => $context['amount'] ?? $reservation->total_amount,
            'status' => 'created',
