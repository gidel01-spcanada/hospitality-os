...
/**
 * The standard Booking.com-derived facility list used to seed a fresh tenant's amenity catalog.
 * Each tenant gets its own copy (see ADR 0002) so it can be renamed/pruned independently.
 */
